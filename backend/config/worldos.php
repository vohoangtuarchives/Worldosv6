    ...
    */
    'engine_registry' => [
        'engines' => [
            ...
            \App\Simulation\Engines\Physics\PotentialFieldEngine::class,
            \App\Simulation\Engines\Physics\CosmicPressureEngine::class,
            \App\Simulation\Engines\Physics\StructuralDecayEngine::class,
            \App\Simulation\Engines\Physics\AdaptiveTopologyEngine::class,
            \App\Simulation\Engines\Meta\LawEvolutionEngine::class,
            \App\Simulation\Engines\Social\ZoneConflictEngine::class,
            \App\Simulation\Engines\Social\CulturalDriftEngine::class,
            \App\Simulation\Engines\Physics\ClimateEngine::class,
            \App\Simulation\Engines\Social\AgricultureEngine::class,
            \App\Simulation\Engines\Social\PopulationEngine::class,
            \App\Simulation\Engines\Social\MigrationEngine::class,
            \App\Simulation\Engines\Social\DiseaseEngine::class,
            \App\Simulation\Engines\Social\CivilizationFormationEngine::class,
            \App\Simulation\Engines\Social\CitySimulationEngine::class,
            \App\Simulation\Engines\Social\GovernanceEngine::class,
            \App\Simulation\Engines\Social\TradeEngine::class,
            \App\Simulation\Engines\Social\KnowledgePropagationEngine::class,
            \App\Simulation\Engines\Social\TechEvolutionEngine::class,
            \App\Simulation\Engines\Social\ReligionEngine::class,
            \App\Simulation\Engines\Social\ArtCultureEngine::class,
            \App\Simulation\Engines\Social\PsychologyEngine::class,
            \App\Simulation\Engines\Social\GlobalEconomyEngine::class,
            \App\Simulation\Engines\Social\MarketEngine::class,
            \App\Simulation\Engines\Social\InequalityEngine::class,
            \App\Simulation\Engines\Social\EcologicalCollapseEngine::class,
            \App\Simulation\Engines\Social\EcologicalPhaseTransitionEngine::class,
            \App\Simulation\Engines\Social\PoliticsEngine::class,
            \App\Simulation\Engines\Social\LegitimacyEliteEngine::class,
            \App\Simulation\Engines\Social\WarEngine::class,
            \App\Simulation\Engines\Physics\GeologicalEngine::class,
            \App\Simulation\Engines\Meta\CausalityEngine::class,
            \App\Simulation\Engines\Meta\MultiverseOsmosisEngine::class,
            \App\Simulation\Engines\Meta\CausalBridgeEngine::class,
        ],
    ],
