...
class ImplicitOrchestratorService
{
     ...
     */
    public function spawnUniverse(World $world, ?int $parentUniverseId = null, ?array $branchPayload = null): Universe
    {
        $parent = null;
        $initialState = null;
        $startTick = 0;
        ...
        if ($parentUniverseId) {
            ...
            if ($parent) {
                ...
                $childGenome = $this->mutationService->mutate($parentGenome, $parent);
            }
        } else {
