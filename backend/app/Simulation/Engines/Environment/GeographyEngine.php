...
namespace App\Simulation\Engines\Environment;

use App\Simulation\Context\SimulationContext;
use App\Simulation\Engines\EngineInterface;
use App\Simulation\Engines\EngineResult;
...
class GeographyEngine implements EngineInterface
{
    ...
    public function handle(WorldState $state, SimulationContext $ctx): EngineResult
    {
        ...
        if (!isset(self::$persistentState[$universeId])) {
            ...
            $result->events[] = \App\Simulation\Events\WorldEvent::create(
