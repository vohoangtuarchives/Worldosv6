...
use App\Simulation\Domain\EngineExecutionRecord;
use App\Simulation\Services\TickMetricsService;
        ...
        foreach ($phaseGroups as $phase => $engines) {
            ...
            if (!empty($parallelBatch)) {
                ...
                foreach ($parallelBatch as $engine) {
                    ...
                    $fiber = new \Fiber(function () use ($engine, $readOnlyState, $ctx): \App\Simulation\Domain\EngineResult {
