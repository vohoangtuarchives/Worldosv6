...
namespace App\Simulation\Entities;
...
class Agent
{
    public function __construct(
        ...
        public float $hunger = 0.0, // Đói bụng (0.0 -> Khỏe; 1.0 -> Chết đói)
        ...
        public IdentityState $identity = new IdentityState(0.5, 0.0, 1.0), // Baseline: worth 0.5, conflict 0.0, align 1.0
