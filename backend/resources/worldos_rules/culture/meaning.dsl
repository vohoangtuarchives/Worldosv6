...
rule Meaning_Coherence_Decay
  ...
  then
    ...
    emit_event IDEOLOGICAL_DISSOLUTION {
      severity: "WARNING",
      description: "Sự hỗn loạn của thực tại đang làm xói mòn tính nhất quán của các hệ thống tư tưởng."
    }
...
rule Religion_Stability_Anchor
  ...
  then
    ...
    emit_event COLLECTIVE_FAITH_STRENGTHENED {
      description: "Trong kỷ nguyên thanh bình, đức tin trở thành ngọn hải đăng neo giữ tâm hồn quần thể."
    }
...
rule Ideology_Radicalization
  ...
  then
    ...
    emit_event IDEOLOGICAL_RADICALIZATION {
      description: "Sự phẫn nộ tập thể đã biến các ý niệm ôn hòa thành những giáo điều cực đoan."
    }
