...
rule Archetype_Martyrdom
  ...
  then
    ...
    emit_event MYTH_RESONANCE {
      archetype: "MARTYR",
      description: "Sự hy sinh anh dũng đã trở thành biểu tượng vĩnh cửu của lòng trung kiên."
    }
...
rule Archetype_Promethean_Spark
  ...
  then
    ...
    emit_event MYTH_RESONANCE {
      archetype: "CREATOR",
      description: "Ngọn lửa tri thức mới đã thắp sáng màn đêm u tối của sự vô tri."
    }
