...
rule Paradigm_Astrometry_Breakthrough
  ...
  then
    ...
    emit_event SCIENTIFIC_BREAKTHROUGH {
      paradigm: "ASTROMETRY",
      description: "Quần thể đã bắt đầu hiểu được vị thế của mình trong vũ trụ bao la."
    }
...
rule Causal_Logic_Paradigm_Shift
  ...
  then
    ...
    emit_event PARADIGM_SHIFT {
      paradigm: "CAUSAL_LOGIC",
      description: "Sự trỗi dậy của logic nhân quả thuần túy đang thách thức những hệ thống niềm tin cổ hủ."
    }
...
rule Quantum_Axioms_Apotheosis
  ...
  then
    ...
    emit_event QUANTUM_REVELATION {
      description: "Bản chất xác suất của thực tại đã được giải mã. Cánh cửa đến Peak state đang mở ra."
    }
