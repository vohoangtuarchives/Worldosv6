...
rule "Apex Trajectory Shield"
    ...
    then
        ...
        log "Apex Shield: Trajectory is locked. Perturbations suppressed.";
end
...
rule "Singularity Collapse Gating"
    ...
    then
        ...
        log "Apex Monitor: Singularity instability detected. Dilating time.";
end
...
rule "Paradox Dampening"
    ...
    then
        ...
        log "Apex Stability: Paradox dampening active.";
end
