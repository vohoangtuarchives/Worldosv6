...
rule Golden_Age_Attractor
  ...
  then
    ...
    emit_event HISTORICAL_PHASE_SHIFT { 
      phase: "GOLDEN_AGE",
      description: "KỶ NGUYÊN HOÀNG KIM: Tri thức và sự ổn định đạt mức cộng hưởng, thúc đẩy sự tiến hóa vượt bậc."
    }
...
rule Dark_Age_Attractor
  ...
  then
    ...
    emit_event HISTORICAL_PHASE_SHIFT { 
      phase: "DARK_AGE",
      description: "THỜI KỲ TỐI TĂM: Sự hỗn loạn (Entropy) và vết sẹo chiến tranh bóp nghẹt các cấu trúc trật tự."
    }
...
rule Expansion_Limit_Constraint
  ...
  then
    ...
    emit_event RESOURCE_LIMIT_REACHED { 
      severity: "CRITICAL",
      description: "GIỚI HẠN SINH TỒN: Quần thể vượt quá khả năng chịu tải của hệ sinh thái."
    }
