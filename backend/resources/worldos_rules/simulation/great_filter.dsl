...
rule Trigger_Singularity_Crisis
  ...
  then
    ...
    metadata description "NGHỊCH LÝ ĐIỂM KỲ DỊ: Công nghệ đột phá vượt xa tầm kiểm soát của đạo đức và niềm tin xã hội."
...
rule Trigger_Stagnation_Crisis
  ...
  then
    ...
    metadata description "SỰ ĐÌNH TRỆ ĐẠI HỆ THỐNG: Truyền thống hủ lậu và bộ máy cồng kềnh đã bóp nghẹt mọi mầm mống đổi mới."
