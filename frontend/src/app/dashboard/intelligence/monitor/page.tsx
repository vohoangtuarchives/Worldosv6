...
export default function NarrativeLoomMonitor() {
    ...
    const providersCount = aiStats?.providers?.length ?? 0;
                ...
                <div className="p-6 rounded-3xl bg-cyan-500/5 border border-cyan-500/10 flex flex-col justify-between">
                    <div>
                        <p className="text-[10px] font-bold text-cyan-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                             <Cpu size={12} /> Synthesis Hub
                        </p>
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] text-slate-500 font-bold uppercase">Material Nodes</span>
                                <span className="text-xs font-mono text-white">Active</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] text-slate-500 font-bold uppercase">Culture Bridge</span>
                                <span className="text-xs font-mono text-white">Linked</span>
                            </div>
                        </div>
                    </div>
                    <div className="mt-4 pt-4 border-t border-cyan-500/10">
                        <p className="text-[9px] font-medium text-slate-400 italic">
                            System projecting material reality into narrative layers...
                        </p>
                    </div>
                </div>
            </div>
