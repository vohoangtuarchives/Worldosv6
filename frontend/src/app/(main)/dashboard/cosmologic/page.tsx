...
import { Activity, Network, Layers, ScrollText, Info, AlertTriangle, Users, Building2, Globe, Library, BookOpen } from "lucide-react";
...
function CosmologicDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"topology" | "evolution" | "chronicles" | "actors" | "factions" | "civilizations" | "archive" | "chronicle-detail">("topology");
