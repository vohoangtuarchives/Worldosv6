        ...
        <div className="bg-card/40 backdrop-blur-sm border border-border rounded-lg p-6 h-full flex flex-col">
            <div className="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm mt-1">Current coordinates in phase space.</p>
                </div>
                <div className="text-right">
                    <div className="text-xs text-muted-foreground uppercase font-semibold">TICK</div>
            ...
            <div className="mt-4 pt-4 border-t border-border flex justify-between items-center text-sm">
                <div className="text-muted-foreground">Emergent Winner:</div>
                <div className="px-3 py-1 bg-muted/60 border border-border rounded-full text-foreground font-medium font-mono text-xs shadow-[0_0_10px_rgba(16,185,129,0.1)]">
                    {data.winner}
                </div>
            </div>
        </div>
