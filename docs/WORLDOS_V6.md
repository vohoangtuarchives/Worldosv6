...
1. Kiến trúc Kiến tạo 5 Tầng (The 5-Layer Worldbuilding Pipeline)
Để hiện thực hóa triết lý "Physics-first" và tránh rơi vào bẫy "thế giới nông / worldbuilding rỗng", WorldOS được thiết kế tuân thủ nghiêm ngặt mô hình kiến tạo 5 tầng nhân quả. Trật tự hệ phân cấp này là luồng chảy duy nhất — đi ngược lại sẽ phá vỡ tính nguyên bản của mô phỏng:

1. **World Layer (Lớp Thực Tại / Physical Reality):** Tầng nền tảng xác định cấu trúc vật lý của vũ trụ (Geography, Climate, Resources). Là cơ sở phân bổ tài nguyên quyết định sự sinh tồn (Ví dụ: Thung lũng ngập lụt sinh ra đế chế nông nghiệp; Mỏ quặng sinh ra vương quốc rèn đúc). Tương ứng với `Universe` framework.
2. **History Layer (Lớp Chuyển Động / Causal Dynamics):** Nơi Simulation Engine chạy vòng lặp nhân quả (`ticks`). Từ Base Reality sinh ra hiện tượng quần thể: di cư, chiến tranh, sụp đổ, trỗi dậy. Lớp này thiết lập logic nhân quả. Mọi sự kiện đều nổi sinh (emergent), không được lập trình trước kịch bản.
3. **Material Layer (Lớp Di Sản / Civilization Output):** Dựa trên hệ quả của History, nền văn minh sản sinh ra sản lượng vật chất và văn hóa (Kiến trúc, Công nghệ, Luật pháp, Tôn giáo, Vật phẩm). Tương ứng với cấu trúc `Material DAG`.
4. **Lore Layer (Lớp Huyền Thoại / Human Interpretation):** Cùng một sự kiện History, nhưng bị bóp méo qua lăng kính diễn giải và lưu truyền của hệ nhận thức. Lịch sử thực ("Vua chết vì ám sát") biến thành Lore ("Vị Vương mang lời nguyền của Thần Mặt Trời"). Trọng tâm ứng dụng AI hoạt động để tóm tắt `Chronicles` thành Myth.
5. **Story Layer (Lớp Tự Sự / Narrative Slice):** Điểm nhọn cuối cùng của chóp. Kể một câu chuyện cụ thể (Story / Chapter) dựa trên một mảnh đời siêu nhỏ cắt ra khỏi ngọn núi Lore khổng lồ kia. Câu chuyện sống động và có trọng lượng vì nó thuộc về một thế giới có lịch sử cả ngàn năm đỡ lấy nó.

2. Mô hình Vũ trụ (Cosmology)
